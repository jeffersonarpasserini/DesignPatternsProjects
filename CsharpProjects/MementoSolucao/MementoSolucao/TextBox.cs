...
public class TextBox : OriginadorInterface
{
    ...
    public TextBox(int x, int y, string text, string fontFamily, int fontSize, 
        string textAlign, string fontWeight)
    {
        this.x = x;
        this.y = y;
        this.text = text;
    ...
    {
        Console.WriteLine($"Configuração caixa de texto: Pos x: {this.x}, y: {this.y} - Texto: {this.text} \n" +
